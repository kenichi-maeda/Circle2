...
#n = 100000000
#csv_filename = 'circles_data_100M.csv'
n = 5
csv_filename = 'circles_data_5.csv'
...
with open(csv_filename, 'w', newline='') as csvfile:
    ...
    for i in range(n):
        ...
        if len(circles) != 4:
            print("4 circles not found!!!!!")
            if len(circles) not in results:
        ...
        progress = (i + 1) / n * 100
        print(f"Progress: {progress:.2f}% - Output file size: {file_size_mb:.2f} MB")
